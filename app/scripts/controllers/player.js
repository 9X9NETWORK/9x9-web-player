      ...
      if(url1.indexOf("m3u8") !== -1){
        //live streaming channel
              ...
              if(/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
                //use html5 player
                  //$("body").append("<div style='position:absolute; left:0; top:0; width : 300px; height:300px; background:red; z-index:1000'>"+url1+"</div>");
                  ...
                  //$("body").append("<div style='position:absolute; left:0; top:0; width : 300px; height:300px; background:red; z-index:1000'>2</div>");
